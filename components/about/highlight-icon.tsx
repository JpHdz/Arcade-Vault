...
/**
 * Pixel-style icons for the about highlights, drawn from rects. They paint with
 * `currentColor`, so the accent class on `.highlight` decides the colour and the
 * glow. Decorative: the highlight's own text says what each one means.
 */
    ...
    return (
      <svg className="hl-icon" viewBox="0 0 16 16" aria-hidden="true">
        <g fill={C}>
          ...
          {/* Title-bar dots are punched out in the page background colour. */}
